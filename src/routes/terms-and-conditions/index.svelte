...
<div class="container">
	...
	<main>
		...
		<p>
			We employ the use of cookies. By accessing elclark.my.id, you agreed to use cookies in
			agreement with the Elclark's Privacy Policy.
		</p>
		...
		<p>
			...
			opinions of Elclark,its agents and/or affiliates. Comments reflect the views and opinions of
			the person who post their views and opinions. To the extent permitted by applicable laws,
			Elclark shall not be liable for the Comments or for any liability, damages or expenses caused
		...
		<p>
			You hereby grant Elclark a non-exclusive license to use, reproduce, edit and authorize others
		...
		<p>
			...
			visibility of the hyperlink compensates the absence of Elclark; and (d) the link is in the
		...
		<p>
			...
			to our website, you must inform us by sending an e-mail to Elclark. Please include your name,
		...
		<p>
			No use of Elclark's logo or other artwork will be allowed for linking absent a trademark
			license agreement.
		</p>
