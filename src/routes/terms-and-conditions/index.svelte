<script>
	...
	const title = 'Elclark - Terms and Conditions'
	const description =
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="Elclark, Code, software engineer, technology, programming, science, music, gaming, terms and conditions"
	/>
	<meta name="description" content={description} />
	<meta name="subject" content="Elclark Terms and Conditions" />
	...
	<meta name="category" content="technology, portfolio, blog, terms and conditions" />
...
<main>
	...
	<p>
		These terms and conditions outline the rules and regulations for the use of Elclark's Website,
		located at <a href="https://elclark.my.id/">https://elclark.my.id/</a>.
	</p>

	<p>
		By accessing this website we assume you accept these terms and conditions. Do not continue to
		use elclark.my.id if you do not agree to take all of the terms and conditions stated on this
		page.
	</p>
	...
	<p>
		...
		with the Elclark's Privacy Policy.
	</p>
	...
	<p>
		...
		all material on elclark.my.id. All intellectual property rights are reserved. You may access
		this from elclark.my.id for your own personal use subjected to restrictions set in these terms
		and conditions.
	</p>

	<p>You must not:</p>
	<ul>
		<li>Republish material from elclark.my.id</li>
		<li>Sell, rent or sub-license material from elclark.my.id</li>
	...
	<p>
		...
		information in certain areas of the website. Elclark does not filter, edit, publish or review
		Comments prior to their presence on the website. Comments do not reflect the views and opinions
		of Elclark,its agents and/or affiliates. Comments reflect the views and opinions of the person
		who post their views and opinions. To the extent permitted by applicable laws, Elclark shall not
	...
	<p>
		Elclark reserves the right to monitor all Comments and to remove any Comments which can be
	...
	<p>
		You hereby grant Elclark a non-exclusive license to use, reproduce, edit and authorize others to
	...
	<p>
		...
		hyperlink compensates the absence of Elclark; and (d) the link is in the context of general
	...
	<p>
		...
		our website, you must inform us by sending an e-mail to Elclark. Please include your name, your
	...
	<p>
		No use of Elclark's logo or other artwork will be allowed for linking absent a trademark license
		agreement.
	</p>
