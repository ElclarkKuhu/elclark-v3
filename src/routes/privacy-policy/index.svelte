...
<main>
	...
	<p>
		At elclark.my.id, accessible from <a href="https://elclark.my.id/">https://elclark.my.id/</a>,
		one of our main priorities is the privacy of our visitors. This Privacy Policy document contains
		types of information that is collected and recorded by elclark.my.id and how we use it.
	</p>
	...
	<p>
		elclark.my.id follows a standard procedure of using log files. These files log visitors when
	...
	<p>
		Like any other website, elclark.my.id uses 'cookies'. These cookies are used to store
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on elclark.my.id, which
	...
	<p>
		Note that elclark.my.id has no access to or control over these cookies that are used by
	...
	<p>
		elclark.my.id's Privacy Policy does not apply to other advertisers or websites. Thus, we are
	...
	<p>
		The right to access &minus; You have the right to request copies of your personal data. We may
		charge you a small fee for this service.
	</p>
	<p>
		The right to rectification &minus; You have the right to request that we correct any information
		you believe is inaccurate. You also have the right to request that we complete the information
		you believe is incomplete.
	</p>
	<p>
		The right to erasure &minus; You have the right to request that we erase your personal data,
		under certain conditions.
	</p>
	<p>
		The right to restrict processing &minus; You have the right to request that we restrict the
		processing of your personal data, under certain conditions.
	</p>
	<p>
		The right to object to processing &minus; You have the right to object to our processing of your
		personal data, under certain conditions.
	</p>
	<p>
		The right to data portability &minus; You have the right to request that we transfer the data
	...
	<p>
		elclark.my.id does not knowingly collect any Personal Identifiable Information from children
