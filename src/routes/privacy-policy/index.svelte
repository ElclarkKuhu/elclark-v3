...
<div class="container">
	...
	<main>
		<p>
			...
			contains types of information that is collected and recorded by elclark.my.id and how we use
			it.
		</p>
		...
		<p>
			...
			elclark.my.id, which are sent directly to users' browser. They automatically receive your IP
		...
		<p>
			The right to rectification &minus; You have the right to request that we correct any
		...
		<p>
			The right to object to processing &minus; You have the right to object to our processing of
