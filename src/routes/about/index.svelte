...
<svelte:head>
	...
	<meta
		name="keywords"
		content="Elclark, Code, software engineer, technology, programming, science, music, gaming, about"
	/>
	<meta name="description" content={description} />
	<meta name="subject" content="About Elclark" />
